...
class institute
{
    ...
    public: string company_code, company_name, contact_no, salary, domain, address, branch, grade, no_student;
    ...
    public:
        ...
        void show()
        {
            ...
            cout<<'\n'<<"\t\t\t\t\t\tGrade criteria :";setcolor(10);cout<<grade;setcolor(6);cout<<'\n'<<"\t\t\t\t\t\tPlacement Intake :";setcolor(10);cout<<no_student;setcolor(6);cout<<endl;
        }
        void acceptData(vector<string> &v)
        {
        ...
        void write(ofstream &x)
        {
            x<<company_code<<','<<company_name<<','<<contact_no<<','<<address<<','<<salary<<','<<domain<<','<<branch<<','<<grade<<','<<no_student<<endl;
        }
        friend void read_file_company();
        friend void write_file_company();
        friend void search_record_company(string);
